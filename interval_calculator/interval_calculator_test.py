import unittest
from intervals_calculator import *
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_t4(self):
        ...
        i1 = [[15, 35], [40, 65], [70, 75], [90, 100]]
        i2 = [[5, 10], [20, 25], [30, 45], [50, 55], [60, 65], [80, 85], [90, 100]]
        r = substract_intervals_itree(i1, i2, debug=True)
        print r
        #exp_res = [[1,2],[4,5],[9,10],[13,19]]
        exp_res = [[15, 20], [25, 30], [45, 50], [55, 60], [70, 75]]
        print exp_res
    ...
    def test_substract_many_out_of_one(self):
        i1 = [[15,35]]
        i2 = [[20,25], [30,45]]
        exp_res = [[15,20],[25,30]]
        r = substract_many_out_of_one(i1[0],i2,True)
        self.assertEqual(r, exp_res)
    ...
    def test_substract_many_out_of_one_one2one(self):
        print "case1"
        i1 = [1, 10]
        i2 = [3, 4]
        er = [[1, 3], [4, 10]]
        r = substract_many_out_of_one(i1, [i2], True)
        self.assertEqual(r, er)
